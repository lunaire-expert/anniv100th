    ...
    <div id="anniv100th">
                ...
                <div class="container" style="position: relative; z-index: var(--z-content);">
                    ...
                    <div class="timeline-container">
                            ...
                            <div class="timeline-content-group">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <div class="timeline-image">
                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/anniv100th/images/showaimage.webp" alt="創業時の写真" style="width: 100%; height: auto; border-radius: 4px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); margin-top: 1rem;">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="timeline-item right fade-in-up">
                            ...
                            <div class="timeline-visual-deco">
                                <span class="deco-title">【昭和】洋式化と羽毛の普及</span>
                                高度経済成長とともにベッド文化が浸透。軽量で保温性に優れた「羽毛ふとん」が登場した寝具の転換期。
                            </div>
                        </div>
                        ...
                        <div class="timeline-item left fade-in-up">
                            ...
                            <div class="timeline-visual-deco">
                                <span class="deco-title">【平成】「快眠」へのこだわり</span>
                                質の高い睡眠への関心が高まり、高機能素材が台頭。個々の体型に合わせた快眠環境の追求が始まりました。
                            </div>
                        </div>
                        ...
                        <div class="timeline-item right fade-in-up">
                            ...
                            <div class="timeline-visual-deco">
                                <span class="deco-title">【令和】テクノロジーの融合</span>
                                AIや最新テクノロジーを活用し、眠りを科学。健康を支えるインフラとして、寝具はさらに進化し続けます。
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="feature-grid">
                        <div class="feature-card fade-in-up">
                            <div class="feature-image-wrapper">
                                <div class="feature-image-placeholder" style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/anniv100th/images/mattress-topper-2.webp');"></div>
                        ...
                        <div class="feature-card fade-in-up">
                            <div class="feature-image-wrapper">
                                <div class="feature-image-placeholder" style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/anniv100th/images/42.webp');"></div>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                // タイムライン要素は個別のスクロール描画ロジックで制御するため除外
                const animatedElements = document.querySelectorAll('.recruitment-section, .message-section .fade-in-up, .feature-card.fade-in-up, .vision-section .fade-in-up');
                ...
                function updateTimelineDrawing() {
                    ...
                    timelineItems.forEach(item => {
                        if (currentLineHeight >= item.offsetTop + 40) {
