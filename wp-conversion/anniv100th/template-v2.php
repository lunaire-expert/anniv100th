...
<head>
    ...
    <!-- Fonts: サイト全体のデザインフォント（Noto等）を読み込み -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link
        href="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@400;500;700&family=Shippori+Mincho:wght@400;700&family=M+PLUS+Rounded+1c:wght@700&display=swap"
        rel="stylesheet">

    <!-- CSS: 各セクションの機能を定義する外部ファイル群 -->
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/anniv100th/css/variables.css"> <!-- 共通変数 -->
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/anniv100th/css/global.css"> <!-- 全体共通 -->
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/anniv100th/css/hero.css"> <!-- ヒーロー専用 -->
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/anniv100th/css/timeline.css"> <!-- タイムライン専用 -->
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/anniv100th/css/feature.css"> <!-- 特長専用 -->
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/anniv100th/css/recruitment.css"> <!-- 採用専用 -->
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/anniv100th/css/vision.css"> <!-- ビジョン専用 -->

    <style>
        /**
         * Zzz Ver. (Bright版) 特有のオーバーライド設定
         * 原本（hero.css）の構成を維持したまま、白基調への色彩変換を適用。
         */
        .hero-bright-ver,
        ...
        .hero-intro-logo {
            ...
            z-index: 0;
            /* メインコンテンツの背面に配置 */
            animation: introLogoMove 3.5s ease-in-out forwards;
            pointer-events: none;
        }
        ...
        @keyframes introLogoMove {
            ...
            95% {
                opacity: 0.1;
                /* テキストの邪魔にならないようさらに薄く */
                transform: translate(-50%, 500%) scale(4.5);
                /* セクションの下辺ギリギリ、あるいは少しはみ出るくらいの位置まで下げる */
            }
    ...
    <div id="anniv100th">
        ...
        <main>
            ...
            <section class="hero hero-bright-ver" id="hero">
                ...
                <div class="hero-content">
                    <!-- イントロアニメーションロゴ -->
                    <div class="hero-intro-logo">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/anniv100th/images/logos/logo_mt_nv.svg" alt="Lunaire Logo" style="width: 100%; height: auto;">
                    </div>
                    ...
                    <h1 class="hero-title">
                        <span class="hero-title-main"><span
                                class="hero-title-accent">100</span>年の歩み、<br>これからの未来へ。</span>
                    </h1>
            ...
            <section id="message" class="message-section"
                ...
                <div class="container">
                    <h2 class="section-title fade-in-up"
                        style="font-family: var(--font-family-serif); margin-bottom: 2rem; letter-spacing: 0.1em; color: var(--primary-color);">
                        感謝を込めて、次の100年へ。
                    </h2>
                    <div class="fade-in-up message-text-wrapper"
                        style="margin: 0 auto; line-height: 2; color: var(--text-main);">
            ...
            <section id="timeline" class="timeline-section section-padding"
                ...
                <div class="timeline-parallax-bg"
                    ...
                    <div class="parallax-overlay"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: rgba(225, 225, 225, 0.85); z-index: 10;">
                    </div>
                    <!-- セクション上部のグラデーション (白60% -> 白0%) -->
                    <div class="parallax-top-gradient"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 300px; background: linear-gradient(to bottom, rgba(255, 255, 255, 0.83) 0%, rgba(255, 255, 255, 0) 100%); z-index: 11;">
                    </div>
                </div>
                ...
                <div class="container" style="position: relative; z-index: var(--z-content);">
                    ...
                    <div class="timeline-container">
                            ...
                            <div class="timeline-content-group">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <div class="timeline-image">
                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/anniv100th/images/showaimage.webp" alt="創業時の写真"
                                            style="width: 100%; height: auto; border-radius: 4px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); margin-top: 1rem;">
                                    </div>
                                </div>
                            </div>
                            <div class="timeline-visual-deco">
                                <span class="deco-title">【大正】綿布団の普及</span>
                                高価な綿布団が都市部から徐々に広まり、藁布団からの転換が進んだ時期。押入れの普及とともに、布団を畳んで収納する生活習慣が定着していきました。
                            </div>
                        </div>

                        <!-- 時代ラベル: 昭和 -->
                        <div class="timeline-era-label fade-in-up era-showa" style="top: 27%;">昭和</div>
                        ...
                        <div class="timeline-item right fade-in-up">
                            ...
                            <div class="timeline-visual-deco">
                                <span class="deco-title">【昭和】一般家庭への定着と多様化</span>
                                高度経済成長期を経て、綿布団が全国の家庭に完全に普及。後期にはベッド文化の浸透とともに、軽量な羽毛布団という新たな選択肢が加わりました。
                            </div>
                        </div>

                        <!-- 時代ラベル: 平成 -->
                        <div class="timeline-era-label fade-in-up era-heisei" style="top: 45%;">平成</div>
                        ...
                        <div class="timeline-item left fade-in-up">
                            ...
                            <div class="timeline-visual-deco">
                                <span class="deco-title">【平成】機能性の追求と新素材</span>
                                ウレタンや合成繊維といった新素材が登場し、体圧分散などの機能性が重視されるように。睡眠を健康管理の一環と捉える意識が強まった時代です。
                            </div>
                        </div>

                        <!-- 時代ラベル: 令和 -->
                        <div class="timeline-era-label fade-in-up era-reiwa" style="top: 74%;">令和</div>
                        ...
                        <div class="timeline-item right fade-in-up">
                            ...
                            <div class="timeline-visual-deco">
                                <span class="deco-title">【令和】多様なスタイルへの最適化</span>
                                培われた知見と素材技術を活かし、個々のライフスタイルや体型に合わせた製品を展開。一人ひとりに寄り添う、より質の高い眠りを追求し続けています。
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="feature" class="feature-section section-padding">
                <div class="container">
                    ...
                    <div class="feature-grid">
                        <div class="feature-card fade-in-up">
                            <div class="feature-image-wrapper">
                                <div class="feature-image-placeholder"
                                    style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/anniv100th/images/mattress-topper-2.webp');"></div>
                        ...
                        <div class="feature-card fade-in-up">
                            <div class="feature-image-wrapper">
                                <div class="feature-image-placeholder" style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/anniv100th/images/42.webp');">
                                </div>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                // 監視対象の登録（フェードイン要素全般）
                // タイムラインの「線に連動する要素（ラベルやアイテム）」以外を登録。
                // ヘッダータイトル（.section-header）は視界に入った瞬間に表示させる。
                const animatedElements = document.querySelectorAll('.recruitment-section, .fade-in-up:not(.timeline-container *)');
                ...
                function updateTimelineDrawing() {
                    ...
                    eraLabels.forEach(label => {
                        // 線の先端がラベルの数ピクセル手前に来たら表示
                        if (currentLineHeight >= label.offsetTop - 5) {
                    ...
                    timelineItems.forEach(item => {
                        // 線の先端がドットの位置（カード上端から約25px下）に到達したら表示
                        if (currentLineHeight >= item.offsetTop + 25) {
                            item.classList.add('is-visible');
                        }
                    });
                }

                // スクロール時、リサイズ時、および初期読み込み時に実行
